...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Y9pfjAZ6Jm', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestashop_melyne', 'user' => 'melyne', 'password' => 'sarah', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ugf9IIHH3z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8opIgz2xuvvUk3kzXUstGE4xa5TmNY91avvBKdU3YEqkwrxosjVWLritECat6po4'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                31 => 'ps_viewedproduct',
                32 => 'ps_brandlist',
                33 => 'ps_faviconnotificationbo',
                34 => 'ps_categoryproducts',
                35 => 'statssales',
                36 => 'statsbestcategories',
                37 => 'dashactivity',
                38 => 'statsregistrations',
                39 => 'ps_cashondelivery',
                40 => 'statsproduct',
                41 => 'statsstock',
                42 => 'dashgoals',
            ...
            'modules_translation_paths' => [
                ...
                28 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                ...
                32 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
            ...
            'kernel.secret' => '8opIgz2xuvvUk3kzXUstGE4xa5TmNY91avvBKdU3YEqkwrxosjVWLritECat6po4',
