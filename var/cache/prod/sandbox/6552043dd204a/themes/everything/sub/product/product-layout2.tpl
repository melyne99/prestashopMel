...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row product_layout_2">
		...
		<div class="pb-center-column col-xs-12 col-sm-4">
            ...
            {if isset($tc_config.YBC_TC_PRODUCT_REF) && $tc_config.YBC_TC_PRODUCT_REF}
            ...
            {/if}
            <div class="clearfix"></div>
            {if isset($tc_config.YBC_TC_CONDITION) && $tc_config.YBC_TC_CONDITION}
			...
			<div id="oosHook"{if $product->quantity > 0} style="display: none;"{/if}>
    			...
    			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
    				...
    				<div class="box-info-product">
    					...
    					<div class="product_attributes clearfix">
    								...
    								{foreach from=$groups key=id_attribute_group item=group}
    									{if $group.attributes|@count}
    										<fieldset class="attribute_fieldset">
    											<label class="attribute_label{if $group.group_type == 'color'} attribute_label_color{/if}" {if $group.group_type != 'color' && $group.group_type != 'radio'}for="group_{$id_attribute_group|intval}"{/if}>{$group.name|escape:'html':'UTF-8'}&nbsp;</label>
    													...
    													<ul id="color_to_pick_list" class="clearfix">
    														...
    														{foreach from=$group.attributes key=id_attribute item=group_attribute}
    															...
    															<li{if $group.default == $id_attribute} class="selected"{/if}>
    																<a href="{$link->getProductLink($product)|escape:'html':'UTF-8'}" id="color_{$id_attribute|intval}" {*name="{$colors.$id_attribute.name|escape:'html':'UTF-8'}"*} class="color_pick color_{$colors.$id_attribute.name|escape:'html':'UTF-8'}{if ($group.default == $id_attribute)} selected{/if}"{if !$img_color_exists && isset($colors.$id_attribute.value) && $colors.$id_attribute.value} style="background:{$colors.$id_attribute.value|escape:'html':'UTF-8'};"{/if} title="{$colors.$id_attribute.name|escape:'html':'UTF-8'}">
    																	{if $img_color_exists}
    						...
    						{/if}
                            {if isset($tc_config.YBC_TC_PRODUCT_QTY) && $tc_config.YBC_TC_PRODUCT_QTY}
                                {if !$PS_CATALOG_MODE}
    						...
    						<div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
    							<p id="add_to_cart" class="buttons_bottom_block no-print">
    								<button type="submit" name="Submit" class="exclusive">
    									<span>
                                            <i class="icon_cart"></i>
                                            {if $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}
                                            {else}{l s='Add to cart'}{/if}
                                        </span>
    								</button>
    							</p>
                                {if ((isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS) || ($HOOK_EXTRA_LEFT) || (isset($tc_config.YBC_TC_USEFUL_LINK) && $tc_config.YBC_TC_USEFUL_LINK) )}
                                    <ul class="box-sharing-button">
                                        ...
                                        {if $HOOK_EXTRA_LEFT}
                                            {$HOOK_EXTRA_LEFT}
                                        {/if}
                                        {if isset($tc_config.YBC_TC_USEFUL_LINK) && $tc_config.YBC_TC_USEFUL_LINK}
                                            <li class="print">
                        						<a href="javascript:print();">{l s='Print'}</a>
                        					</li>  
                                        {/if}
                                    </ul>
                                {/if}
                ...
                {if !$content_only}
                    ...
                    {if ((isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT) || (isset($tc_config.YBC_TC_SOCIAL_SHARING) && $tc_config.YBC_TC_SOCIAL_SHARING))}
        ...
        <div class="pb-right-column col-sm-4">
            {if !$content_only}
                <div id="tab_product_page">
                  <!-- Nav tabs -->
                  <ul class="tab_product_page_content">
                    {if isset($accessories) && $accessories}
            			<!--Accessories -->
                        <li>
                			<section class="page-product-box" id="product_accessories">
                                <h4 class="title_toggle active">
                                    {l s='You may also like'}</h4>
                				<div class="block products_block accessories-block clearfix content_toggle active">
                					<div class="block_content">
                						<ul id="bxslider_custom" class="bxslider2 product_list accessories_slider clearfix">
                                                            ...
                                                            <div class="left-block">
                                                                ...
                                                                <div class="ybc_button_option">
                                                					{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
                                                						<div class="no-print">
                                                							<a class="exclusive button ajax_add_to_cart_button" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart' mod='productscategory'}">
                    ...
                    {if isset($product) && $product->description}
                        <li>
                            ...
                            {if isset($product) && $product->description}
                    			<!-- More info -->
                    			<div class="content_toggle active" id="product_description">
                    ...
                    {if isset($features) && $features}
                        <li>
                            ...
                            {if isset($features) && $features}
                    			<!-- Data sheet -->
                    			<div class="content_toggle active" id="product_featured">
                    ...
                    {if isset($attachments) && $attachments}
                        <li>
                            <h4 class="title_toggle">
                                {l s='Download'}
                            </h4>
                            {if isset($attachments) && $attachments}
                			     <!--Download -->
                    			<section class="page-product-box tab-pane content_toggle" id="product_download">
                    ...
                    {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
                        <li>
                            ...
                            {if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
                    			<!-- quantity discount -->
                    			<section class="page-product-box tab-pane content_toggle" id="product_discount">
