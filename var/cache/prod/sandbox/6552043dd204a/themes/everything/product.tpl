...
{if isset($tc_config.YBC_TC_PRODUCT_LAYOUT) && $tc_config.YBC_TC_PRODUCT_LAYOUT == 'layout2'}
    {include file="$tpl_dir./sub/product/product-layout2.tpl"}
{else}
...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row product_layout_1">
		...
		{/if}
		<!-- left infos-->
		<div class="pb-left-column col-xs-12 col-sm-6 col-lg-4">
			<!-- product img-->
        ...
        <!-- center infos -->
		<div class="pb-center-column col-xs-12 col-sm-6 col-lg-4">
        ...
        <div class="pb-right-column col-xs-12 col-sm-12 col-lg-4">
            {if !$content_only}
                			...
                			<section class="page-product-box" id="product_accessories">
                				...
                				<div class="block products_block accessories-block clearfix content_toggle active">
                					<div class="block_content">
                						<ul id="bxslider_custom" class="bxslider2 accessories_slider product_list">
