...
<div class="panel col-lg-12">
    <div class="panel-heading">
        ...
        <span class="panel-heading-action">            
            <a class="list-toolbar-btn" href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&configure=ybc_megamenu&add_new_menu=true&control=menu">
    				...
    				<li class="ybc-menu-item" rel="{$menu.id_menu|escape:'html':'UTF-8'}" id="menu_{$menu.id_menu|escape:'html':'UTF-8'}">
                        	...
                        	<div class="ybc-mm-level1 ybc-mm-item">			
                                ...
                                <div class="ybc-mm-toolbox">
                                    <a onclick="return confirm('{l s='When you delete this menu, all columns/blocks inside this menu will be deleted. Do you confirm?' mod='ybc_megamenu'}');" style="text-decoration: none!important; margin-right: 10px;" href="{$admin_path|escape:'html':'UTF-8'}&id_menu={$menu.id_menu|escape:'html':'UTF-8'}&control=menu&configure=ybc_megamenu&delmenu=true">
                                    ...
                                    <a  style="text-decoration: none!important;"  href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&add_new_column=true&id_menu={$menu.id_menu|escape:'html':'UTF-8'}&control=column&configure=ybc_megamenu" class="list-toolbar-btn">
                                    ...
                                    {foreach from=$menu.columns item=column}
                        				<li class="ybc-column-item" rel="{$column.id_column|escape:'html':'UTF-8'}" id="column_{$column.id_column|escape:'html':'UTF-8'}" >
                                            ...
                                            <div class="ybc-level2 ybc-mm-item">					
                                                ...
                                                <div class="ybc-mm-toolbox">
                                                    <a onclick="return confirm('{l s='When you delete this column, all blocks inside this column will be deleted. Do you confirm?' mod='ybc_megamenu'}');" style="text-decoration: none!important; margin-right: 10px;" href="{$admin_path|escape:'html':'UTF-8'}&id_column={$column.id_column|escape:'html':'UTF-8'}&control=column&configure=ybc_megamenu&delcolumn=true">
                                                    ...
                                                    <a  style="text-decoration: none!important;"  href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&add_new_column=true&id_column={$column.id_column|escape:'html':'UTF-8'}&control=block&configure=ybc_megamenu" class="list-toolbar-btn">
                                        				...
                                        				<li class="ybc-block-item" rel="{$block.id_block|escape:'html':'UTF-8'}" id="block_{$block.id_block|escape:'html':'UTF-8'}" >
                                                            <!-- Level 3 -->
                                                                <div class="ybc-level3 ybc-mm-item">					
                                                                    ...
                                                                    <div class="ybc-mm-toolbox">
                                                                        <a onclick="return confirm('{l s='This block will be deleted. Do you confirm?' mod='ybc_megamenu'}');" style="text-decoration: none!important;" href="{$admin_path|escape:'html':'UTF-8'}&id_block={$block.id_block|escape:'html':'UTF-8'}&control=block&configure=ybc_megamenu&delblock=true">
