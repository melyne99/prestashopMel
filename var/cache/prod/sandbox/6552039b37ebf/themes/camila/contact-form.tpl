                    		...
                    		<div>
                    			...
                    			<div class="clearfix">
                                    ...
                                    {if isset($tc_config.YBC_TC_CONTACT_PAGE_TEXT) && $tc_config.YBC_TC_CONTACT_PAGE_TEXT}
                                        <div class="col-xs-12 col-sm-12 col-md-6 contact_infor">
                                                    ...
                                                    <li class="contact_store_information_item">
                                                        ...
                                                        <div class="contact_store_information_right">
                                                            ...
                                                            {if (isset($tc_config.BLOCKCONTACTINFOS_PHONE) && $tc_config.BLOCKCONTACTINFOS_PHONE)}
                                                                <div class="content">
                                                                    {$tc_config.BLOCKCONTACTINFOS_PHONE}
                                                                </div>
                                                            {/if}
                                                        </div>
                                                    </li>
                    				...
                    				<div class="col-xs-12 col-sm-12 col-md-6 contact_infor_forminput">
                    					<div class="row">
                        					...
                        					<p class="form-group">
                        						{if isset($customerThread.email)}
                        							<input class="form-control grey" type="text" id="email" name="from" placeholder="{l s='Email address'}" value="{$customerThread.email|escape:'html':'UTF-8'}" readonly="readonly" />
                        						{else}
                        							<input class="form-control grey validate" type="text" id="email" placeholder="{l s='Email address'}" name="from" data-validate="isEmail" value="{$email|escape:'html':'UTF-8'}" />
                        						{/if}
                        					</p>
                        					{if !$PS_CATALOG_MODE}
                        						{if (!isset($customerThread.id_order) || $customerThread.id_order > 0)}
                        							<div id="contact_reference" class="form-group selector1">
                        								...
                        								{elseif !isset($customerThread.id_order) && empty($is_logged)}
                        									<input class="form-control grey" type="text" placeholder="{l s='Order reference'}" name="id_order" id="id_order" value="{if isset($customerThread.id_order) && $customerThread.id_order|intval > 0}{$customerThread.id_order|intval}{else}{if isset($smarty.post.id_order) && !empty($smarty.post.id_order)}{$smarty.post.id_order|escape:'html':'UTF-8'}{/if}{/if}" />
                        								{elseif $customerThread.id_order|intval > 0}
                        									<input class="form-control grey" type="text" placeholder="{l s='Order reference'}" name="id_order" id="id_order" value="{if isset($customerThread.reference) && $customerThread.reference}{$customerThread.reference|escape:'html':'UTF-8'}{else}{$customerThread.id_order|intval}{/if}" readonly="readonly" />
                        								{/if}
                        							</div>
                        						{/if}
                        						{if isset($is_logged) && $is_logged}
                    								...
                    								{elseif $customerThread.id_product > 0}
                                                        <div id="contact_order_products" class="form-group selector1">
                    									<input  type="hidden" name="id_product" id="id_product" placeholder="{l s='Product'}" value="{$customerThread.id_product|intval}" readonly="readonly" />
                    								    </div>
                                                    {/if}
                        						{/if}
                        					{/if}
                        					{if $fileupload == 1}
                        						<div id="ybc_attach_file" class="form-group">
                        							<input type="hidden" name="MAX_FILE_SIZE" placeholder="{l s='Attach File'}" value="{if isset($max_upload_size) && $max_upload_size}{$max_upload_size|intval}{else}2000000{/if}" />
        	...
        	<form action="{$request_uri}" method="post" class="contact-form-box contact-form-box-layout-3" enctype="multipart/form-data">
        		<div>
        			...
        			<div class="clearfix">
                        ...
                        {/if}
                        {if isset($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE) && $tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE}
                            <div class="col-xs-12{if isset($tc_config.YBC_TC_CONTACT_PAGE_TEXT) && $tc_config.YBC_TC_CONTACT_PAGE_TEXT} col-sm-12 col-md-4 ybc_delay03{else} col-sm-6{/if} embe_map_contact">
                                {$tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE}
                            </div>
                        {/if}
        				...
        				<div class="col-xs-12{if (isset($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE) && 
                                                    ...
                                                    $tc_config.YBC_TC_CONTACT_PAGE_TEXT)} col-sm-12 col-md-4{elseif (($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE =='' && 
                                                    $tc_config.YBC_TC_CONTACT_PAGE_TEXT) ||
                                                    ($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE &&  
                                                    $tc_config.YBC_TC_CONTACT_PAGE_TEXT == ''))} col-sm-12 {elseif (isset($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE) && 
                                                    $tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE == '' &&
                                                    isset($tc_config.YBC_TC_CONTACT_PAGE_TEXT) &&
            					...
            					{if !$PS_CATALOG_MODE}
            						{if (!isset($customerThread.id_order) || $customerThread.id_order > 0)}
            							<div id="contact_reference" class="form-group selector1">
            								...
            								{elseif !isset($customerThread.id_order) && empty($is_logged)}
            									<input class="form-control grey" placeholder="{l s='Order reference'}" type="text" name="id_order" id="id_order" value="{if isset($customerThread.id_order) && $customerThread.id_order|intval > 0}{$customerThread.id_order|intval}{else}{if isset($smarty.post.id_order) && !empty($smarty.post.id_order)}{$smarty.post.id_order|escape:'html':'UTF-8'}{/if}{/if}" />
            								{elseif $customerThread.id_order|intval > 0}
            									<input class="form-control grey" placeholder="{l s='Order reference'}" type="text" name="id_order" id="id_order" value="{if isset($customerThread.reference) && $customerThread.reference}{$customerThread.reference|escape:'html':'UTF-8'}{else}{$customerThread.id_order|intval}{/if}" readonly="readonly" />
            								{/if}
            							</div>
            						{/if}
            						{if isset($is_logged) && $is_logged}
        	...
        	<form action="{$request_uri}" method="post" class="contact-form-box" enctype="multipart/form-data">
        		<div>
        			...
        			<div class="clearfix">
                        ...
                        {/if}
                        {if isset($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE) && $tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE}
                            <div class="col-xs-12 col-sm-12 col-md-6 embe_map_contact">
                                {$tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE}
                            </div>
                        {/if}
                        
        				<div class="contact_infor_forminput col-xs-12{if isset($tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE) && $tc_config.YBC_TC_GOOGLE_MAP_EMBED_CODE} col-sm-12 col-md-6{/if}">
        					<div class="row">
                                <div class="form-group selector1">
            					{if isset($customerThread.id_contact) && $customerThread.id_contact && $contacts|count}
            							{assign var=flag value=true}
