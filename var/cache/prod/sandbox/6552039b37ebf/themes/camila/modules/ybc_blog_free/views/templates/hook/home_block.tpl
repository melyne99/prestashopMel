{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'DEFAULT' || $tc_config.YBC_TC_LAYOUT == 'LAYOUT6' || $tc_config.YBC_TC_LAYOUT == 'LAYOUT2' || $tc_config.YBC_TC_LAYOUT == 'LAYOUT5')}
    {hook h='ybccustom3'}
{/if}
{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT4' )}
    <div class="container">{hook h='ybccustom5'}</div>
{/if}
{if $posts}
<div class="container homeblog_wrapper">
    <div class="homeblog ybc_blog_skin_{$blog_skin nofilter}">
            ...
            <ul id="{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT != 'LAYOUT3')}ybc-blog-posts-home-list{/if}" class="{if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3')}ybc-blog-posts-home-list-layout3{/if} ybc_popular_posts">
                ...
                {foreach from=$posts item='post'}
                    ...
                    {if $is==1*}
                        ...
                        {*assign var='liclosed' value=false}
                    {/if*}
                    <!--<div class="ybc-blog-posts-home-list-item ybphli-{$is nofilter}{if $is==1} smallwidth col-sm-4{elseif $is==2} col-sm-8 largeblog{/if}">-->
                       <div class="ybc-blog-posts-home-list-item">
                        <div class="ybc-blog-posts-home-list-item-content">
                            <div class="ybc-blog-home-post-wrapper {if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3')}col-sm-6 col-md-6{/if}">                        
                                    {if $post.thumb}<a class="ybc_item_img" href="{$post.link nofilter}"><img src="{$post.thumb nofilter}" alt="{$post.title nofilter}" title="{$post.title nofilter}" /></a>{/if}
                                    {*if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT != 'LAYOUT3')}
                                    <div class="post-date"><span class="ybc_date">{date('d', strtotime($post.datetime_added))} </span>
                                    <span class="ybc_m_y">{date('M', strtotime($post.datetime_added))} 
                                    <br />{date('Y', strtotime($post.datetime_added))}</span> 
                                    </div>{/if*}
                            </div> 
                            <div class="ybc-blog-home-content-show {if (isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3')}col-sm-6 col-md-6{/if}">
                                ...
                                {/if*}
                                            <a class="ybc_title_block" href="{$post.link nofilter}">{$post.title nofilter}</a>
                                                ...
                                                <div class="ybc-blog-categories">
                                                    ...
                                                    {*<div class="be-categories">                                                 
                                                        {foreach from=$post.categories item='cat'}
                                                            ...
                                                            <a href="{$cat.link nofilter}">{ucfirst($cat.title)}</a>{if $ik < $totalCat}, {/if}
                                                        {/foreach}
                                                    </div>*}
                                                </div>
                                            {/if}
                                            ...
                                            <div class="ybc_count_comment">                                                                                                                                   
                                                    {if $allowComments}
                                                        <span class="ybc-blog-home-toolbar-comments">{$post.comments_num nofilter} {if $post.comments_num!=1}<span>{l s='comments'}</span>{else}<span>{l s='comment'}</span>{/if}</span>
                                                    {/if}
                                             </div>*}
                                           
                                            
                            
                                            <!--<a class="read_more" href="{$post.link nofilter}">{l mod='ybc_blog' s='Read more'}</a>-->
                                {*if ($is==2)}                                         
                                        </div>
                                    </div>
                                {/if*}
