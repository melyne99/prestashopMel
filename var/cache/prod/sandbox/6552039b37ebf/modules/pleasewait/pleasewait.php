...
class Pleasewait extends Module
{
    ...
    public function renderConfig()
    {
     ...
     {     
        if(!(int)Configuration::get('PLW_ENABLED') || (!isset($this->context->controller->php_self) || isset($this->context->controller->php_self) && $this->context->controller->php_self!='index') && Configuration::get('PLW_HOMEPAGE_ONLY'))
            return;
