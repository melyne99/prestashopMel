...
<div class="ybc-newsletter-popup{if $YBC_NEWSLETTER_MOBILE_HIDE} ynp-mobile-hide{/if} {$YBC_NEWSLETTER_TEMPLATE|escape:'html':'UTF-8'} ybc-mail-wrapper">
    <div class="ynp-div-l1">
        <div class="ynp-div-l2 ybc_animation">
            <span class="ynp-close close_click"></span>
                        ...
                        <div class="ynp-inner">
                            ...
                            <div class="ynp-inner-wrapper">
                                {if isset($YBC_NEWSLETTER_POPUP_TITLE) && $YBC_NEWSLETTER_POPUP_TITLE != ''}
                                    <h1>{if $YBC_NEWSLETTER_LOGO}<span class="nlt_logo"><img src="{$YBC_NEWSLETTER_LOGO|escape:'html':'UTF-8'}" /></span>{/if}
                                    {$YBC_NEWSLETTER_POPUP_TITLE|escape:'html':'UTF-8'}</h1>
                                {/if}
                                
                                {if isset($YBC_NEWSLETTER_IMAGE) && $YBC_NEWSLETTER_IMAGE != ''}
                                    <div class="nlt_img"><img src="{$YBC_NEWSLETTER_IMAGE|escape:'html':'UTF-8'}" alt="" /></div>
                                {/if}
                                <div class="nlt_content">
                                    {$YBC_NEWSLETTER_POPUP_CONTENT|escape:'quotes':'UTF-8' nofilter}
