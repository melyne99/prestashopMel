...
<div id="search_block_top" class="search_layout_3 {if $searched_categories}has-categories-dropdown{else}no-categories-dropdown{/if}">
	<span class="toogle_search_top icon_search"></span>
