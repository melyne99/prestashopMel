						...
						<div class="col-md-8">
							...
							<div class="btn-group-action pull-right">
								...
								<a class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&configure=ybc_nivoslider&id_slide={$slide.id_slide|escape:'html':'UTF-8'}">
									<i class="icon-edit"></i>
								...
								<a onclick="return confirm('{l s='Do you want to delete this slide?' mod='ybc_nivoslider'}')" class="btn btn-default"
									href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&configure=ybc_nivoslider&delete_id_slide={$slide.id_slide|escape:'html':'UTF-8'}">
