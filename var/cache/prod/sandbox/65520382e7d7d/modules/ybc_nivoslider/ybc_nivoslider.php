...
class Ybc_nivoslider extends Module
{
    ...
    private $default_show_control = 0;
    private $default_button_image = 1;
	...
	public function hookdisplayHeader($params)
	{
		if (!isset($this->context->controller->php_self) || $this->context->controller->php_self != 'index')
			return;
		$this->context->controller->addCSS($this->_path.'views/css/nivo/themes/default/default.css');
        $this->context->controller->addCSS($this->_path.'views/css/nivo/nivo-slider.css');
    ...
    private function installSample()
     {       
       ...
       if($oldFiles = glob(dirname(__FILE__).'/images/*'))
        ...
        $this->copyDir(dirname(__FILE__).'/views/img/data/',dirname(__FILE__).'/images/');
    }
