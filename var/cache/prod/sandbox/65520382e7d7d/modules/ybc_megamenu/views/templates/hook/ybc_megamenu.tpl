        ...
        <div class="ybc-menu-main-content" id="ybc-menu-main-content">            
                ...
                <ul class="ybc-menu">  
        			{foreach from=$menus item=menu}
                        {if $menu.enabled}
            				<li class="{if isset($menu.columns) && $menu.columns}ybc-menu-has-sub{/if} ybc-menu-item {if $menu.custom_class}{$menu.custom_class|escape:'html':'UTF-8'}{/if} ybc-menu-sub-type-{strtolower($menu.menu_type)|escape:'html':'UTF-8'}{if $menu.column_type} ybc-menu-column-type-{strtolower($menu.column_type)|escape:'html':'UTF-8'}{else} ybc-menu-column-type-left{/if} {if !$menu.wrapper_border}no-wrapper-border{/if} {if $menu.sub_type}sub-type-{strtolower($menu.sub_type)|escape:'html':'UTF-8'}{else}sub-type-title{/if}" id="ybc-menu-{$menu.id_menu|escape:'html':'UTF-8'}">
                                    <!-- level 1 -->
                                    {if $menu.url}
                                	   <a class="ybc-menu-item-link" href="{$menu.url|escape:'html':'UTF-8'}">{if $menu.show_icon && $menu.icon}<i class="fa icon {$menu.icon|escape:'html':'UTF-8'} {str_replace('fa-','icon-',$menu.icon)|escape:'html':'UTF-8'}"></i> {/if}<span>{$menu.title|escape:'html':'UTF-8'}</span>{if isset($menu.columns) && $menu.columns} <span class="icon-submenu-exist"></span>{/if}</a>
                                    {else}
                                        <a class="ybc-menu-item-link ybc-menu-item-no-link" href="#" ><span class="">{if $menu.show_icon && $menu.icon}<i class="fa icon {$menu.icon|escape:'html':'UTF-8'} {str_replace('fa-','icon-',$menu.icon)|escape:'html':'UTF-8'}"></i> {/if}{$menu.title|escape:'html':'UTF-8'}</span></a>
                                    {/if}
                                    <!-- /leve 1 -->
                                    <!-- Columns -->
                                    {if isset($menu.columns) && $menu.columns || $menu.image}
                                        <span class="ybc-mm-control closed"></span>
                                        <div {if $menu.sub_menu_max_width && $menu.sub_menu_max_width}style="max-width: {$menu.sub_menu_max_width|intval}%;"{/if} class="ybc-menu-columns-wrapper ybc-mm-control-content" id="ybc-menu-columns-wrapper-{$menu.id_menu|escape:'html':'UTF-8'}">
                                    				...
                                    				<div class="ybc-menu-column-item ybc-menu-column-size-{$column.column_size|escape:'html':'UTF-8'} {if $column.custom_class}{$column.custom_class|escape:'html':'UTF-8'}{/if}" id="ybc-menu-column-{$column.id_column|escape:'html':'UTF-8'}">
                                                        ...
                                                        {if isset($column.blocks) && $column.blocks}                                                        
                                                                {foreach from=$column.blocks item=block}
                                                                    {if $block.enabled}
                                                                        <div class="ybc-menu-block {if $block.custom_class}{$block.custom_class|escape:'html':'UTF-8'}{/if} ybc-menu-block-type-{strtolower($block.block_type)|escape:'html':'UTF-8'}">
                                                                            ...
                                                                            {if $block.block_type=='HTML' && isset($block.html_block) && $block.html_block}
                                                                                <div class="ybc-menu-block-bottom ybc-menu-block-custom-html">
                                                                                    {$block.html_block|escape:'html':'UTF-8'}
                                                                                </div>
                                                                            {/if}  
                                                                                        ...
                                                                                        {foreach from=$block.urls item='url'}                                                                                        
                                                                                            <li class="{if isset($url.info) && $url.info}ybc-mm-product-block{else}ybc-no-product-block{/if}">
                                                                                                ...
                                                                                                {if isset($url.info) && $url.info}
                                                                                                    ...
                                                                                                    {/if}
                                                                                                {/if}                                                                                            
                                                                                                {if isset($block.subCategories.$subcatId) && $block.subCategories.$subcatId}{$block.subCategories.$subcatId|escape:'html':'UTF-8'}{/if}                                                                                           
                                                                                            </li>
                                                                                        {/foreach}
                                                                                    </ul>
                                                                                </div>
