...
{if $PLW_HTML || $PLW_LOADING_MESSAGE}
    <div class="plw_content" style="background: {$PLW_BACKGROUND_COLOR|escape:'htmlall':'UTF-8'};">
        <div class="plw_content_center">
            {if $PLW_HTML}<div class="plw_icon plw_{$PLW_SPINNER_TYPE|escape:'html':'UTF-8'}">{str_replace(array('{bgcolor}','{size}','{size2}'),array($PLW_ICON_COLOR,$PLW_SPINNER_SIZE,$PLW_SPINNER_SIZE2),$PLW_HTML) nofilter}</div>{/if}
