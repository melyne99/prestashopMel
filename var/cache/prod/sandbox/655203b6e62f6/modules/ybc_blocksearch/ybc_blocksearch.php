...
class Ybc_blockSearch extends Module
{
	...
	public function hookDisplayTop($params)
	{
        ...
        $this->getCategoriesDropdown($categoriesTree);                
        $this->smarty->assign(array('searched_categories' => $this->categoryDropDown ? '<select class="searched_category" name="searched_category"><option value="0">'.$this->l('CATEGORIES').'</option>'.$this->categoryDropDown.'</select><span class="select-arrow"></span>' : false));     
