...
{if !isset($product) || isset($product) && $product && isset($tc_product) && !is_object($product) || isset($product) && !$product}
    {assign var='product' value=$tc_product}
{/if}

<div id="idTab5" class="content_toggle">
	{if $comments}
		{foreach from=$comments item=comment}
			{if $comment.content}
			<div class="comment row" itemprop="review" itemscope itemtype="https://schema.org/Review">
				<div class="comment_author col-xs-12">
				...
				<div class="comment_details comment_details col-xs-12">
