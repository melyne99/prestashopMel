...
class __TwigTemplate_5268668f62aaa2108006cd8ad81f617a3d61200528d4612b417e08b990399027 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["child"] ?? null), "children", [], "any", true, true, false, 53)) {
            // line 54
            echo "      <ul ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 54), "expanded", [], "any", false, false, false, 54), false))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Product/Themes/categories_theme.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Product/Themes/categories_theme.html.twig");
    }
}
