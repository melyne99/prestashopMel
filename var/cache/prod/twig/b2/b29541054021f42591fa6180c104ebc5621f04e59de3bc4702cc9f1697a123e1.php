...
class __TwigTemplate_a9f5a5f4dfc10cc170bcfd04115f7174edda2f933513214662442e18b11d74f8 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"col-md-9\">
    <div class=\"alert alert-info\" role=\"alert\">
      <p class=\"alert-text\">
        ";
        // line 77
        if ((0 === twig_compare($this->extensions['PrestaShopBundle\Twig\LayoutExtension']->getConfiguration("PS_REWRITING_SETTINGS"), 0))) {
            // line 78
            echo "          <strong>";
      ...
      <p class=\"alert-text\">
        ";
        // line 86
        if ((0 === twig_compare($this->extensions['PrestaShopBundle\Twig\LayoutExtension']->getConfiguration("PS_FORCE_FRIENDLY_PRODUCT"), 1))) {
            // line 87
            echo "          <strong>";
...
";
    ...
    {
        return new Source("", "@Product/ProductPage/Forms/form_seo.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Forms/form_seo.html.twig");
    }
}
