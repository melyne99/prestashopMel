...
class __TwigTemplate_57d25c895f7f2b8bc2883bec6e24a101a03d28c18bd1af75e6378cd77cc7ee81 extends Template
{
    private $source;
    private $macros = [];
...
($context["placeholder"] ?? null), "type" => "text"]);
    ...
    ";
        ...
        // line 61
        if ((0 === twig_compare(($context["list_layout"] ?? null), "table"))) {
            // line 62
            $this->displayBlock("entity_search_table_layout", $context, $blocks);
        } else {
            // line 64
    ...
    <div class=\"row\">
      <div class=\"col-sm\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            ...
            // line 93
            echo "              ";
            if ((0 !== twig_compare(($context["childType"] ?? null), "hidden"))) {
                // line 94
                echo "                <th>";
...
";
    ...
    public function block_entity_item_row($context, array $blocks = [])
    {
        ...
        // line 114
        echo "  ";
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "parent", [], "any", false, false, false, 114), "vars", [], "any", false, false, false, 114), "list_layout", [], "any", false, false, false, 114), "table"))) {
            // line 115
            $this->displayBlock("entity_item_table_row", $context, $blocks);
        } else {
            // line 117
...
";
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/TwigTemplateForm/entity_search_input.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm/entity_search_input.html.twig");
    }
}
