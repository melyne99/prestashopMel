...
class __TwigTemplate_d25c184db5c17039c256cdebac8612958b6a0912bd4daeefc5e1d6f7b26c444f extends Template
{
    private $source;
    private $macros = [];
  ...
  <ul class=\"pagination mb-0\">
    ...
    <li class=\"page-item next ";
        // line 36
        if ((array_key_exists("next_url", $context) && (0 !== twig_compare(($context["next_url"] ?? null), false)))) {
        } else {
            echo "disabled";
        }
        echo "\">
    ...
    <li class=\"page-item ";
        // line 39
        if ((array_key_exists("last_url", $context) && (0 !== twig_compare(($context["last_url"] ?? null), false)))) {
        } else {
            echo "disabled";
        }
        echo "\">
    ...
    <div class=\"form-group row mb-0\">
      ...
      <div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["limit_choice"]) {
            ...
            echo "\" ";
            if ((0 === twig_compare(($context["limit"] ?? null), $context["limit_choice"]))) {
                echo "selected=\"selected\"";
            }
            echo ">";
            echo twig_escape_filter($this->env, $context["limit_choice"], "html", null, true);
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/pagination.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Common/pagination.html.twig");
    }
}
