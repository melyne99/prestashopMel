...
class __TwigTemplate_c57d40ce1bf9e0f094f9cc280cf6ae2402cd2cbb2b54b956ddfd5672144632f9 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <a
          class=\"attribute-group-name ";
            // line 126
            if (((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 126), 3)) || ($context["has_combinations"] ?? null))) {
                echo " collapsed ";
            }
            echo "\"
          data-toggle=\"collapse\"
          ...
          aria-expanded=\"";
            // line 129
            if (((0 >= twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 129), 3)) ||  !($context["has_combinations"] ?? null))) {
                echo "true";
            } else {
                echo "false";
            }
        ...
        <div class=\"collapse ";
            // line 133
            if (((0 >= twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 133), 3)) &&  !($context["has_combinations"] ?? null))) {
                echo " show ";
            }
          ...
          <div class=\"attributes-overflow ";
            // line 134
            if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["attribute_group"], "attributes", [], "any", false, false, false, 134)), 7))) {
                echo " two-columns ";
            }
            echo "\">
            ";
...
";
    ...
    {
        return new Source("", "@Product/ProductPage/Forms/form_combinations.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Product/ProductPage/Forms/form_combinations.html.twig");
    }
}
