...
class __TwigTemplate_00d23b8a6ed42cbbfad0db6ab139abcd7df3522b9a9e93531af6fe64336bd18d extends Template
{
    private $source;
    private $macros = [];
...
($context["label"] ?? null) === false)) {
    ...
    <div class=\"";
      ...
      ";
        // line 95
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "parent", [], "any", false, true, false, 95), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 95), "name", [], "any", false, false, false, 95), [], "any", true, true, false, 95) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "parent", [], "any", false, false, false, 95), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 95), "name", [], "any", false, false, false, 95), [], "any", false, false, false, 95), "vars", [], "any", false, false, false, 95), "multistore_dropdown", [], "any", false, false, false, 95), false)))) {
            // line 96
            echo "        ";
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/TwigTemplateForm/prestashop_ui_kit.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm/prestashop_ui_kit.html.twig");
    }
}
