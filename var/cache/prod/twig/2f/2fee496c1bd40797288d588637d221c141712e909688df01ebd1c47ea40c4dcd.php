...
class __TwigTemplate_d8b5245e8dc9bf83dff21df35cdddfef3493986548d0e2912b3642ca9c5fc84e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card\" id=\"checkConfiguration\">
      ...
      <div class=\"card-body\">
        <div class=\"card-text\">
          ";
        // line 207
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["requirements"] ?? null), "failRequired", [], "any", false, false, false, 207), false))) {
            // line 208
            echo "            <p>
              <strong>";
            // line 209
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["value"]) {
                // line 219
                echo "                ";
                if ((0 === twig_compare("fail", $context["value"]))) {
                    // line 220
                    echo "                  <li>";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["requirements"] ?? null), "failOptional", [], "any", true, true, false, 225)) {
            // line 226
            echo "            ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["requirements"] ?? null), "failOptional", [], "any", false, false, false, 226), false))) {
                // line 227
                echo "              <p>
                <strong>";
                // line 228
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Configure/AdvancedParameters/system_information.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters/system_information.html.twig");
    }
}
