...
class __TwigTemplate_1cc82874f5712a998e64190c33553e1de622e64b46a2823536f5261039092099 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_product_catalog_form_table_row($context, array $blocks = [])
    {
        ...
        if ($this->extensions['PrestaShopBundle\Twig\LayoutExtension']->getConfiguration("PS_STOCK_MANAGEMENT")) {
            ...
            echo "#tab-step3\">
                    ";
            // line 67
            if ((twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "sav_quantity", [], "any", true, true, false, 67) && (1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "sav_quantity", [], "any", false, false, false, 67), 0)))) {
                // line 68
                echo "                        ";
...
($context["buttons_action"] ?? null)]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Product/CatalogPage/Lists/list.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Product/CatalogPage/Lists/list.html.twig");
    }
}
