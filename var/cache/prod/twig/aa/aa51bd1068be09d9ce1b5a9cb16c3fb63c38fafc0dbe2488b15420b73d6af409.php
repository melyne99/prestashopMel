...
class __TwigTemplate_d2b76ace690f835c1b6aa0237da7f4267f3edf3e8d17818699662727945f07b9 extends Template
{
    private $source;
    private $macros = [];
...
>
  ...
  ";
        // line 58
        if ((1 === twig_compare(($context["product_count_filtered"] ?? null), 20))) {
            // line 59
            echo "        ";
...
($context["last_sql"] ?? null)]);
    ...
    {
        return new Source("", "@Product/CatalogPage/Forms/form_products.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Product/CatalogPage/Forms/form_products.html.twig");
    }
}
