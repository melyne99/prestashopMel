...
class __TwigTemplate_0c803fab3bf96392264e9da694e3df7acb12fe56ede133083012afe01a82ed29 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_product_catalog_form_table_header($context, array $blocks = [])
    {
        ...
        echo "
          ...
          ";
        // line 74
        if ((0 === twig_compare(($context["has_category_filter"] ?? null), true))) {
            // line 75
            echo "            <th scope=\"col\">
              ";
            // line 76
...
($context["filters_disabled"] ?? null)]));
        ...
        echo "\"
                ...
                <option value=\"1\" ";
        // line 181
        if ((array_key_exists("filter_column_active", $context) && (0 === twig_compare(($context["filter_column_active"] ?? null), "1")))) {
            echo "selected=\"selected\"";
        }
        echo ">Active</option>
                <option value=\"0\" ";
        // line 182
        if ((array_key_exists("filter_column_active", $context) && (0 === twig_compare(($context["filter_column_active"] ?? null), "0")))) {
            echo "selected=\"selected\"";
        }
...
($context["last_sql"] ?? null)]));
    ...
    {
        return new Source("", "@Product/CatalogPage/Lists/products_table.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Product/CatalogPage/Lists/products_table.html.twig");
    }
}
