...
class __TwigTemplate_2521a8a88a741e80c5817e7259a9a805c615c253043c5b673fe4406ba6455045 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-lg-10\">
      <div id=\"module-short-list-update\" class=\"module-short-list\">
        ...
        ";
        // line 37
        if (((1 === twig_compare(twig_length_filter($this->env, ($context["modules"] ?? null)), 1)) && (0 <= twig_compare(($context["level"] ?? null), twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_UPDATE"))))) {
            // line 38
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/updates.html.twig", "/home/melyne/webapps/app-prestamel/src/PrestaShopBundle/Resources/views/Admin/Module/updates.html.twig");
    }
}
